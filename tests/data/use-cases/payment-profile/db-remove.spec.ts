...
function makeSut() {
  ...
  const sut = new DbRemovePaymentProfileUseCase(
...
describe(DbRemovePaymentProfileUseCase.name, () => {
  test('Should remove paymentProfile and return correct values for CARD_PAYMENT', async () => {
  ...
  describe.each([
    ...
    ({ properties, validations }) => {
      it(JSON.stringify(validations), async () => {
        ...
        const requestModel = { ...properties } as RemovePaymentProfileUseCase.RequestModel;
